...
var initialise = function initialise() {
    ...
    application.fadeColour = 'rgba(200,200,200,.03)';
    application.fillColour = 'rgba(130,130,130,1)';
    ...
    var addTracer = function addTracer(position, colour) {
        ...
        if (colour) {
            ...
            tracer.colour = 'RGBA(' + Math.round(Math.random() * 255) + ',' + 100 + Math.round(Math.random() * 155) + ',' + 55 + Math.round(Math.random() * 200) + ',0.2)';
        }
